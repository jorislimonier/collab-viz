    ...
    tabsetPanel(
        tabPanel("Introduction", 
                 p("This is the visualisation created for the Data Visualisation module for the MSc Data Science and AI degree. 
                   It was created for the final evaluation of the module by Marlize de Villiers.
                 ...
                 p("On the ", em("Visualisation tab"), "you will see two main panels.
                   ...
                   in the upper left corner of the visualisation, or by using your mouse's scroller. You can also navigate
                   around the map once you zoomed in by clicking and dragging the map with your mouse.
                   You can also click on the legend with the continents to show only certain continents' data."
                   ),
                 p(em("Some notes: The dataset contained many missing information, that is why there are no data for some 
                      countries. You can choose to see the data that cannot be allocated to a country or a year by selecting
...
server <- function(input, output) {
    ...
    observe(if (input$bubble == "total_awards") {
        ...
        #aw_alb <- reactive('Albums released: {point.z}', 'Awards received: {point.x}')
    ...
    observe(if (input$bubble == "b") {
        ...
        #aw_alb <- reactive('Albums released: {point.z}, Awards received: {point.z1}')
        bubbles_size_alb <- reactive(data_2()$z)
        #bubbles_size_aw <- reactive(data_2()$z)
