...
Figure \ref{fig:joris_sankey_overview} shows an overview of what the default Sankey view looks like.
...
\begin{table}[h!]
    ...
    \begin{tabular}{lll}
        ...
        2.                  & Selecting                              & Hover over the links to see exact number, source and target \\ \midrule
        3.                  & Filter                                 & Only show one or more genres                                \\ \bottomrule
    \end{tabular}
